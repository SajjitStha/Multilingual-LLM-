...
def whisper_transcribe_nepali(wav_path: str) -> str:
    """
    Use Whisper to convert speech -> Nepali text.
    """
...
def generate_nepali_reply(user_text: str) -> str:
    ...
    prompt = (
        ...
        f"प्रयोगकर्ताको वाक्य (नेपाली ASR आउटपुट, गल्ती हुन सक्छ):\n'{user_text}'\n\n"
...
def on_speak_button():
    ...
    try:
        ...
        append_status("Whisper ले सुन्दैछ...")
        user_text = whisper_transcribe_nepali(wav_path)
...
append_chat("सिस्टम", "नमस्ते! म तिम्रो अफलाइन नेपाली भ्वाइस सहायक हुँ। मसँग नेपालीमा कुरा गर।")
